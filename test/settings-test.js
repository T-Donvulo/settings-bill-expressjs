...
describe('settings-bill', function(){
    ...
    it('should calculate the right totals', function(){
        ...
        assert.equal(2.35, settingsBill.allTotal().smsCostTotal);
        assert.equal(3.35, settingsBill.allTotal().callCostTotal);
        assert.equal(5.70, settingsBill.allTotal().grandTotal);
    ...
    it('should calculate the right totals for multiple actions', function(){
        ...
        assert.equal(4.70, settingsBill.allTotal().smsCostTotal);
        assert.equal(6.70, settingsBill.allTotal().callCostTotal);
        assert.equal(11.40, settingsBill.allTotal().grandTotal);
    ...
    it('should know when critical level reached', function(){
        ...
        assert.equal(true, settingsBill.checkCriticalLevel());
